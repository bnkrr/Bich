...
local Bich = {
    instanceType = {
        ...
        [12] = "Normal Scenario",
        [13] = "Not Used",
        [14] = "10-30-Player Normal Raid",
        [15] = "10-30-Player Heroic Raid",
        [16] = "20-Player Mythic Raid",
        [17] = "10-30-Player Looking for Raid",
        [18] = "40-player Event raid",  -- Used by the level 100 version of Molten Core for WoW's 10th anniversary
        [19] = "5-player Event",  -- Used by the level 90 version of UBRS at WoD launch
        [20] = "Event Scenario",  -- unknown usage
        [23] = "5-Player Mythic",
        [24] = "5-Player Timewalker",
    },
